      ...
      <main className={styles.main}>
        <Container style={{ padding: '0 30px' }}>
          <Row style={{ marginBottom: '0.5rem' }}>
            <Col col={4} lg={3}><Text style={{ fontWeight: 'bold' }}># of infants</Text></Col>
            <Col col={4}>
          ...
          <TextBox style={{ marginTop: 8, marginBottom: '1.5rem', padding: '28px 18px' }}>** 00<br />Estimated # of child care workers</TextBox>
          <Row style={{ marginBottom: '0.5rem' }}>
          ...
          <TextBox style={{ marginTop: 8, marginBottom: '1.5rem', padding: '28px 18px' }}>** 00<br />Estimated # of preschool teachers</TextBox>
          <Row style={{ marginBottom: '0.5rem' }}>
          ...
          <TextBox style={{ marginTop: 8, marginBottom: '1.5rem', padding: '28px 18px' }}>** 00<br />Estimated # of child care administrators (center director of family child care owner)</TextBox>
          <div style={{ margin: '20px 0', display: 'inline-block' }} />
          <Row style={{ marginBottom: '0.5rem' }}>
            <Col col={4} lg={3}>
              <Text style={{ fontWeight: 'bold' }}># of ccw</Text>
            </Col>
            <Col col={8} label=''>
          ...
          <Row style={{ display: 'flex', justifyContent: 'space-between', padding: '120px 0 60px 0' }}>
            ...
            >
              ...
              <Title style={{ margin: 0, marginTop: 4, fontSize: 20 }}>Child Care feasibility calculator</Title>
            </Col>
            <Col
              col={12}
              md={6}
